import { a as createComponent, r as renderTemplate, d as renderComponent, e as renderSlot, f as renderHead, c as createAstro, b as addAttribute } from './astro/server_DwRF4eQR.mjs';
import 'kleur/colors';
/* empty css                          */
import { $ as $$Favicon, a as $$GoogleFont, b as $$ThemeScript, c as $$FontAwesome, d as $$Header, e as $$Footer, f as getPageMeta } from './Footer_C0yCkBN5.mjs';
/* empty css                        */
import 'clsx';
import { S as SITE_TITLE, a as SITE_DESCRIPTION, b as SITE_URL, T as TWITTER_HANDLE } from './config_BJeKzReB.mjs';

const $$PageLayout = createComponent(($$result, $$props, $$slots) => {
  return renderTemplate`<html class="theme-sleek" lang="en" data-astro-cid-3zbxo6iv> <head><meta charset="utf-8"><meta name="viewport" content="width=device-width,initial-scale=1"><meta name="generator" content="KCS">${renderComponent($$result, "Favicon", $$Favicon, { "data-astro-cid-3zbxo6iv": true })}${renderSlot($$result, $$slots["meta"])}${renderComponent($$result, "GoogleFont", $$GoogleFont, { "data-astro-cid-3zbxo6iv": true })}${renderComponent($$result, "ThemeScript", $$ThemeScript, { "data-astro-cid-3zbxo6iv": true })}${renderComponent($$result, "FontAwesome", $$FontAwesome, { "data-astro-cid-3zbxo6iv": true })}${renderHead()}</head> <body class="min-h-screen max-w-3xl mx-auto px-6 sm:px-8" data-astro-cid-3zbxo6iv> ${renderComponent($$result, "Header", $$Header, { "data-astro-cid-3zbxo6iv": true })} <main id="main" data-astro-cid-3zbxo6iv> ${renderSlot($$result, $$slots["main"])} </main> ${renderComponent($$result, "Footer", $$Footer, { "data-astro-cid-3zbxo6iv": true })}  </body> </html>`;
}, "C:/Users/kendr/my_blog/src/layouts/PageLayout.astro", void 0);
...
}, "C:/Users/kendr/my_blog/src/components/PageMeta.astro", void 0);
